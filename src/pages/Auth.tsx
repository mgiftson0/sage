  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img
          src="https://images.unsplash.com/photo-1590735213920-68192a487bc2?w=1200&auto=format&fit=crop"
          alt="Ghanaian fashion"
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-background">
            ...
            <motion.p
              ...
              className="text-background/80 max-w-md mx-auto"
            >
              Join our community and discover handcrafted Ghanaian fashion 
              that celebrates tradition and contemporary style.
            </motion.p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-muted-foreground">
              {isLogin 
                ...
                : "Join the Afides family and discover authentic Ghanaian fashion"}
            </p>
          </motion.div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-border bg-background text-foreground focus:outline-none focus:border-primary transition-colors pr-12"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 px-4 py-3 border border-border text-foreground hover:bg-secondary transition-colors">
